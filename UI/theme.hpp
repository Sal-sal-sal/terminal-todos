...
inline ftxui::Color accent()      { return ftxui::Color::Cyan; }       // focus
...
inline ftxui::Color heatmap_level(int level) {
    switch (level) {
        case 0:  return ftxui::Color::RGB(34, 37, 46);   // empty
        case 1:  return ftxui::Color::RGB(14, 68, 41);   // low
        case 2:  return ftxui::Color::RGB(0, 109, 50);   // mid
        case 3:  return ftxui::Color::RGB(38, 166, 65);  // high
        default: return ftxui::Color::RGB(57, 211, 83);  // max
    }
}
